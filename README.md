...
* [`src/cljs/solitaire/`](src/cljs/solitaire/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/solitaire/core.cljs): contains the SPA entry point, `init`
...
7. Clone this repo and open a terminal in the `solitaire` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/solitaire/config.cljs) defaults to `true` in
...
(ns solitaire.example
  (:require [solitaire.config :as config])
